...
public class MemoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            vh  = new ViewHolder();
            vh.vTitle = convertView.findViewById(R.id.note_title);
    ...
    private List<Map<String, Object>> readSQL() {
        ...
        String[] projection = {
                ...
                MemoContract.MemoTable.COLUMN_NAME_USERNAME
        };
        ...
        Cursor c = db.query(
                ...
                projection,
                MemoContract.MemoTable.COLUMN_NAME_USERNAME +"=?",
                new String[]{MainActivity1.nameString},
                null,
                null,
                sortOrder
        );
        ...
        while(c.moveToNext()) {
            ...
            tempData.put(MemoContract.MemoTable.COLUMN_NAME_USERNAME,
                    c.getString(c.getColumnIndex(MemoContract.MemoTable.COLUMN_NAME_USERNAME)));
            ret.add(tempData);
        }
        c.close();
        db.close();
    ...
    public void addMemo(String t, String c, String n, long modtime) {
        ...
        values.put(MemoContract.MemoTable.COLUMN_NAME_USERNAME, n);
    ...
    public void updateMemo(int id, String t, String c, String n, long modtime) {
        SQLiteDatabase db = sqlHelper.getWritableDatabase();
